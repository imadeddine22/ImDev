...
const personal_content: DataType = {
 ...
 title: 'Passionate about building modern, responsive and user-friendly websites.',

  email: "ieddine008gmail.com",
  ...
  education_data: [
    {
      id: 1,
      time: "2023 - 2024",
      designation: "licance comminication",
      collage: "University of Algiers"
    },
    {
      id: 2,
      time: "2023 - 2024",
      designation: "Web Development Diploma",
      collage: "lilix consullting"
    },
                ...
                <div className="ab-personal-info__left-box mr-200">
                  <div className="tp-services-wrapper tp-services-capsule-wrapper p-relative"
                    ...
                    <div className="tp-services-capsule-item-wrapper">
                      ...
                      <p data-tp-throwable-el="">
                        <span className="tp-services-capsule-item" style={{ backgroundColor: "#00CC97" }}>Testing</span>
                      </p>
                      <p data-tp-throwable-el="">
                        <span className="tp-services-capsule-item" style={{ backgroundColor: "#19B3F1" }}>UI/UX Design</span>
                      </p>
                      <p data-tp-throwable-el="">
                        <span className="tp-services-capsule-item" style={{ backgroundColor: "#FF759C" }}>Security</span>
                      </p>
                      <p data-tp-throwable-el="">
