...
import portfolio_img_1 from "@/assets/img/portfolio/image/portfolio-1.jpg";
import portfolio_img_2 from "@/assets/img/portfolio/image/portfolio-2.jpg";
import portfolio_img_3 from "@/assets/img/portfolio/image/portfolio-3.jpg";
                  ...
                  <div className="tp-portfolio-item mb-70">
                    <Link href="/portfolio">
                      ...
                      <div className="tp-portfolio-content">
                        <h3 className="tp-portfolio-title">Portfolio website </h3>
